...
public  interface PEvents extends scala.Serializable {
  ...
  /**
   * @deprecated Use PEventStore.find() instead. Since 0.9.2. 
  */
  ...
  */
   ...
   *
   * @deprecated Use PEventStore.aggregateProperties() instead. Since 0.9.2. 
  */
   ...
   * @param entityType (undocumented)
   * @param startTime (undocumented)
   * @param untilTime (undocumented)
   * @param required (undocumented)
   * @param sc (undocumented)
   * @param extract (undocumented)
