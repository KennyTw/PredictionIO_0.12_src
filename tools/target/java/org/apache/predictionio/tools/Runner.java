...
public  class Runner {
  static public  scala.collection.immutable.Map<java.lang.String, java.lang.String> envStringToMap (java.lang.String env)  { throw new RuntimeException(); }
  static public  scala.Option<java.lang.String> argumentValue (scala.collection.Seq<java.lang.String> arguments, java.lang.String argumentName)  { throw new RuntimeException(); }
  static public  java.lang.String handleScratchFile (scala.Option<org.apache.hadoop.fs.FileSystem> fileSystem, scala.Option<java.net.URI> uri, java.io.File localFile)  { throw new RuntimeException(); }
  static public  void cleanup (scala.Option<org.apache.hadoop.fs.FileSystem> fs, scala.Option<java.net.URI> uri)  { throw new RuntimeException(); }
  static public  scala.collection.Seq<java.lang.String> detectFilePaths (scala.Option<org.apache.hadoop.fs.FileSystem> fileSystem, scala.Option<java.net.URI> uri, scala.collection.Seq<java.lang.String> args)  { throw new RuntimeException(); }
   ...
   */
  static public  scala.collection.immutable.Map<java.lang.String, scala.collection.Seq<java.lang.String>> groupByArgumentName (scala.collection.Seq<java.lang.String> arguments)  { throw new RuntimeException(); }
   ...
   */
  static public  scala.collection.Seq<java.lang.String> removeArguments (scala.collection.Seq<java.lang.String> arguments, scala.collection.immutable.Set<java.lang.String> remove)  { throw new RuntimeException(); }
   ...
   */
  static public  scala.collection.Seq<java.lang.String> combineArguments (scala.collection.Seq<java.lang.String> arguments, scala.collection.immutable.Map<java.lang.String, scala.Function2<java.lang.String, java.lang.String, java.lang.String>> combinators)  { throw new RuntimeException(); }
