...
public  class JsonExtractorOption {
  static public  scala.Enumeration.Value Json4sNative ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value Gson ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value Both ()  { throw new RuntimeException(); }
